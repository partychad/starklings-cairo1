...
fn multiply_element_by_10(ref dict: Felt252Dict<u32>, n: usize) {
    ...
    let mut n = 0 ;//TODO : make a function that multiplies the elements stored at the indexes 0 to n of a dictionary by 10
    loop {
        if n == 10 {
            break;
        }
        let value = dict.get(n);
        dict.insert(n, value * 10);
        n = n + 1;
